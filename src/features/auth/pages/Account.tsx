...
export function Account() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="max-w-7xl bg-white mx-auto px-6 py-12 flex-1 w-full">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 mb-6">
              ...
              <div className="flex flex-col items-center text-center mb-6">
                <div className="w-20 h-20 bg-gray-200 mb-3 overflow-hidden">
                  {user.avatar ? (
                    <ImageWithFallback
                      src={user.avatar}
                      alt={user.name}
              ...
              <nav className="space-y-1">
                {tabs.map((tab) => (
                  ...
                  >
                    <tab.icon className="w-5 h-5" strokeWidth={1}/>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white p-6">
                    ...
                    {orders.map((order) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <span
                            className={`px-3 py-1 text-xs font-body ${getStatusColor(
                              order.status
                            )}`}
                          >
                            {order.status}
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-black">
                          ...
                          <div className="flex gap-2">
                            <button className="px-4 py-2 border border-black hover:bg-gray-50 text-sm transition-colors font-body">
                              Track Order
                            </button>
                            <button className="px-4 py-2 bg-black text-white hover:bg-gray-800 text-sm transition-colors font-body">
                              View Details
                            </button>
                          </div>
                        </div>
                ...
                <div>
                  ...
                  {isLoadingFavorites ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 font-body">No favorites to show!</p>
                    </div>
                  ) : (
                      ...
                      {favoriteProducts.map((product) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="mt-2 inline-flex items-center justify-center gap-2 px-4 py-2 border border-black hover:bg-gray-50 text-sm transition-colors font-body"
                          >
              ...
              {activeTab === 'profile' && (
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl mb-6 font-headline">Profile Information</h2>
                    {!isEditing ? (
                      <button
                        onClick={() => {
                          setIsEditing(true);
                        ...
                        className="flex items-center gap-2 px-4 py-2 border border-black hover:bg-gray-50 transition-colors font-body"
                      >
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-black text-white hover:bg-gray-800 transition-colors font-body"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          disabled={!isEditing}
                          className="w-full px-4 py-3 border border-black focus:outline-none focus:border-black disabled:bg-gray-50 font-body"
                        />
                      </div>
                      <div>
              ...
              {activeTab === 'addresses' && (
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl mb-6 font-headline">Shipping Addresses</h2>
                    <button className="px-4 py-2 bg-black text-white hover:bg-gray-800 transition-colors font-body">
                      Add New
                    </button>
                  </div>
                  ...
                  {user.address ? (
                    ...
                    <div className="text-center py-12 border border-black">
                      <MapPin className="w-16 h-16 mx-auto text-gray-300 mb-4" strokeWidth={1} />
                      <p className="text-gray-500 font-body">No saved addresses to show!</p>
                    </div>
                  )}
                </div>
              )}
              ...
              {activeTab === 'payment' && (
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl mb-6 font-headline">Payment Methods</h2>
                    <button className="px-4 py-2 bg-black text-white hover:bg-gray-800 transition-colors font-body">
                      Add Card
                    </button>
                  </div>
                  ...
                  <div className="text-center py-12 border border-black">
                    <CreditCard className="w-16 h-16 mx-auto text-gray-300 mb-4" strokeWidth={1} />
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="border-b border-black pb-6">
                      <h3 className="mb-4 font-normal font-body">Notifications</h3>
                      <div className="space-y-3">
                        <label className="flex items-center justify-between cursor-pointer">
                          <span className="text-gray-700 font-normal font-body">Email notifications</span>
                          <input type="checkbox" defaultChecked className="rounded" />
                        </label>
                        <label className="flex items-center justify-between cursor-pointer">
                          <span className="text-gray-700 font-normal font-body">Order updates</span>
                          <input type="checkbox" defaultChecked className="rounded" />
                        </label>
                        <label className="flex items-center justify-between cursor-pointer">
                          <span className="text-gray-700 font-normal font-body">Promotional emails</span>
                    ...
                    <div className="border-b border-black pb-6">
                      <h3 className="mb-4 font-normal font-body">Privacy</h3>
                      <div className="space-y-3">
                        <label className="flex items-center justify-between cursor-pointer">
                          <span className="text-gray-700 font-normal font-body">Make profile public</span>
                          <input type="checkbox" className="rounded" />
                        </label>
                        <label className="flex items-center justify-between cursor-pointer">
                          <span className="text-gray-700 font-normal font-body">Show order history</span>
                          <input type="checkbox" className="rounded" />
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <h3 className="mb-4 text-red-600 font-body">Danger Zone</h3>
                      <button className="px-4 py-2 border border-red-300 text-red-600 hover:bg-red-50 transition-colors font-body">
                        Delete Account
                      </button>
                    </div>
                  </div>
